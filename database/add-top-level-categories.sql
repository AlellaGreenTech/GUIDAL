...
DELETE FROM public.activity_categories WHERE slug IN ('school-field-trip', 'family-farm-visit', 'all-events', 'special-lunches');
...
INSERT INTO public.activity_categories (name, slug, description, image_url, display_order) VALUES
  ...
  ('All Events', 'all-events', 'Special events, seasonal celebrations, and community gatherings', 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&h=400&fit=crop', -2),
