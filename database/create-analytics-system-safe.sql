-- ========================================================================
-- COMPREHENSIVE ANALYTICS SYSTEM FOR GUIDAL (SAFE VERSION)
-- ========================================================================
...
ALTER TABLE analytics_events
  ADD CONSTRAINT fk_analytics_abandoned
  FOREIGN KEY (abandoned_booking_id) REFERENCES abandoned_bookings(id) ON DELETE SET NULL;
