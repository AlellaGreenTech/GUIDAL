            ...
            if (activity.title && activity.title.includes('Halloween Maxi-Party 2025')) {
                return `
                    <div style="display: flex; gap: 0.5rem; align-items: center;">
                        <a href="/events/pumpkin-patch-checkout.html?open=party" class="btn btn-primary" style="background: #ff6b35 !important; border-color: #ff6b35 !important;">Book</a>
                        <a href="https://chat.whatsapp.com/HnWhcfwNLenGKXMFOR6JUG" target="_blank" class="btn btn-success" style="background: #25D366 !important; border-color: #25D366 !important; display: flex; align-items: center; gap: 0.3rem;">
                            ...
                            WhatsApp for directions/info
                        </a>
                    </div>
                `;
            }

            // Halloween Mini-Party (Nov 1) - with WhatsApp button
